...
public class FXMLAnchorPaneProcessosVendasDialogController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        clienteDAO.setConnection(connection);//está setando a conexão do com o clienteDAO e o ProdutoDAO
    ...
    public void handleButtonConfirmar() {
        //se a entrada de dados for válida, vou setar os meus dados
    ...
    //Feito para verificar ser todos os campos foram preenchidos 
